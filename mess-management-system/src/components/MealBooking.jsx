            ...
            <div className="container-fluid service py-6">
                <div className="container">
                    ...
                    <div className="row g-4">
                        <div className="col-lg-12 col-md-6 col-sm-12 wow bounceInUp" data-wow-delay="0.7s">
                            <div className="bg-light rounded service-item">
                                <div className="service-content d-flex align-items-center justify-content-center p-4">
                                    <div className="service-content-icon text-center">
                                        ...
                                        <Link to="/meal-booking" className="btn btn-primary px-4 py-2 rounded-pill">Place Order</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
