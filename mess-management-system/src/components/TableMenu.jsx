...
const TableMenu = () => {
  ...
  const getTodaysMenu = () => {
    ...
    return {
        breakfast: menu.thisWeek.breakfast[dayOfWeek]?.item || "No item",
        lunch: menu.thisWeek.lunch[dayOfWeek]?.item || "No item",
        dinner: menu.thisWeek.dinner[dayOfWeek]?.item || "No item"
    };
  };
